...
/// @notice Handler for blockchain-level operations (time, blocks)
contract L2HandlerBlockchain is Test {
  ...
  function handler_roll(uint256 _delta) external {
    vm.roll(vm.getBlockNumber() + bound(_delta, 0, _MAX_ROLL_DELTA));
  }
}
