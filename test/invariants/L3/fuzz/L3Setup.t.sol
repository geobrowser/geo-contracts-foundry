...
import {HandlerDAOSpace} from 'test/invariants/L3/fuzz/handlers/HandlerDAOSpace.t.sol';
import {HandlerSpaceRegistry} from 'test/invariants/L3/fuzz/handlers/HandlerSpaceRegistry.t.sol';
import {HandlerVerifierSpace} from 'test/invariants/L3/fuzz/handlers/HandlerVerifierSpace.t.sol';
import {L3HandlerBlockchain} from 'test/invariants/L3/fuzz/handlers/L3HandlerBlockchain.t.sol';

contract L3Setup is Test, DeployL3Contracts {
  ...
  L3HandlerBlockchain public handlerBlockchain;
  ...
  function _configureTargets() internal {
    ...
    handlerBlockchain = new L3HandlerBlockchain();
