...
interface IMembers {
  ...
  /// @param dao The address of the DAO whose plugin has added members.
  /// @param members The addresses of the new members.
  event MembersAdded(address dao, address[] members);
