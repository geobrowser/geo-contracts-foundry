...
contract TestGovernancePluginsSetup is PluginSetup, IGovernancePluginsSetup {
  ...
  function prepareInstallation(
    ...
    permissions[1] = PermissionLib.MultiTargetPermission({
      ...
      who: _dao,
      condition: PermissionLib.NO_CONDITION,
      permissionId: MainVotingPlugin(mainVotingPluginImplementationAddr).UPDATE_VOTING_SETTINGS_PERMISSION_ID()
    });
    ...
    permissions[2] = PermissionLib.MultiTargetPermission({
      ...
      who: _dao,
      condition: PermissionLib.NO_CONDITION,
      permissionId: MainVotingPlugin(mainVotingPluginImplementationAddr).UPDATE_ADDRESSES_PERMISSION_ID()
    });
  ...
  function decodeUpdateParams(bytes memory _data) public pure returns (bool requestSomeNewPermission) {
